---
title: 常用API
date: 2024-05-14 17:27:37
updated: 2024-05-14 17:27:37
excerpt: 黑马java开发学习资料day18
categories:
  - 后端
tags:
  - Java
...
查看API文档，我们可以看到API文档中关于Math类的定义如下：
 ...
 ![1576047659085](/img/常用API/1576047659085.png) 
...
![1576047846672](/img/常用API/1576047846672.png) 
...
查看API文档，我们可以看到API文档中关于System类的定义如下：
 ...
 ![1576049347968](/img/常用API/1576049347968.png) 
...
![1576049535584](/img/常用API/1576049535584.png) 
...
![1576053677194](/img/常用API/1576053677194.png) 
...
![1576053871503](/img/常用API/1576053871503.png) 
...
![1576055135105](/img/常用API/1576055135105.png) 

2. 选择toString，此时会弹出如下的对话框

![1576055198877](/img/常用API/1576055198877.png) 
...
1. 在空白处使用快捷键：alt + insert。此时会弹出如下的对话框
 ...
 ![1576056718392](/img/常用API/1576056718392.png) 

2. 选择equals() and hashCode()方法，此时会弹出如下的对话框

![1576057779458](/img/常用API/1576057779458.png) 

点击next，会弹出如下对话框：

![1576057813175](/img/常用API/1576057813175.png) 

选择neme和age属性点击next，此时就会弹出如下对话框：

![1576057892814](/img/常用API/1576057892814.png) 
...
![浅克隆](/img/常用API/浅克隆.png)

**深克隆：**

​	基本数据类型拷贝过来，字符串复用，引用数据类型会重新创建新的

![深克隆](/img/常用API/深克隆.png)
...
![1576058492444](/img/常用API/1576058492444.png) 
...
![1576058659628](/img/常用API/1576058659628.png) 
...
查看API文档，我们可以看到API文档中关于BigInteger类的定义如下：
 ...
 ![Snipaste_2022-09-04_21-36-01](/img/常用API/Snipaste_2022-09-04_21-36-01.png)
...
![bigInteger的底层原理](/img/常用API/bigInteger的底层原理.png)
...
查看API文档，我们可以看到API文档中关于BigDecimal类的定义如下：
 ...
 ![1576132679789](/img/常用API/1576132679789.png)
...
要用BigDecimal类，那么就需要首先学习一下如何去创建BigDecimal的对象。通过查看API文档，我们可以发现Jdk中针对BigDecimal类提供了很多的构造方法，但是最常用的构造方法是：
 ...
 ![1576134383441](/img/常用API/1576134383441.png)
...
把数据看成字符串，遍历得到里面的每一个字符，把这些字符在ASCII码表上的值，都存储到数组中。
 ...
 ![bigdecimal存储原理](/img/常用API/bigdecimal存储原理.png)
